...
const CARDS: CategoryCard[] = [
  ...
  { id: 'bold-impactful',       label: 'Bold Impactful',       tagline: 'Dark · huge type · commanding',          sampleId: 'creative',   Icon: Zap,         gradient: 'from-zinc-900 via-zinc-800 to-red-950',           textColor: 'text-red-400',      iconBg: 'bg-red-500/20',      templateId: 'TechnicalBold',       previewBg: '#0A0A0A', accentHex: '#FF3B00' },
  ...
  { id: 'warm-human',           label: 'Warm Human',           tagline: 'Earthy · rounded · personal',            sampleId: 'healthcare', Icon: Heart,       gradient: 'from-orange-50 via-amber-50 to-stone-100',        textColor: 'text-orange-700',   iconBg: 'bg-orange-100',      templateId: 'TechnicalWarm',     previewBg: '#FAF7F2', accentHex: '#C0622B' },
  { id: 'creative-studio',      label: 'Creative Studio',      tagline: 'Asymmetric · expressive · artistic',     sampleId: 'creative',   Icon: Palette,     gradient: 'from-stone-100 via-purple-50 to-stone-200',       textColor: 'text-purple-700',   iconBg: 'bg-purple-100',      templateId: 'TechnicalAnimated', previewBg: '#F0EDEB', accentHex: '#7B5EA7' },
  { id: 'tech-cyber',           label: 'Tech Cyber',           tagline: 'Terminal · neon · matrix grid',          sampleId: 'tech',       Icon: Code2,       gradient: 'from-slate-900 via-cyan-950 to-slate-900',        textColor: 'text-cyan-300',     iconBg: 'bg-cyan-500/20',     templateId: 'TechnicalVibrant',  previewBg: '#040A10', accentHex: '#00FF88' },
  { id: 'classic-professional', label: 'Classic Professional', tagline: 'Serif · structured · print-ready',       sampleId: 'business',   Icon: Briefcase,   gradient: 'from-slate-50 via-blue-50 to-slate-100',          textColor: 'text-blue-800',     iconBg: 'bg-blue-100',        templateId: 'TechnicalClassic',  previewBg: '#F8F8F6', accentHex: '#2A5298' },
  { id: 'vibrant-playful',      label: 'Vibrant Playful',      tagline: 'Multi-color · rounded · energetic',      sampleId: 'marketing',  Icon: TrendingUp,  gradient: 'from-yellow-50 via-orange-50 to-pink-50',         textColor: 'text-rose-600',     iconBg: 'bg-rose-100',        templateId: 'TechnicalGlossy',   previewBg: '#FFFBF0', accentHex: '#FF6B6B' },
  { id: 'editorial',            label: 'Editorial',            tagline: 'Magazine layout · pull quotes',           sampleId: 'creative',   Icon: Type,        gradient: 'from-stone-50 via-red-50 to-stone-100',           textColor: 'text-red-700',      iconBg: 'bg-red-100',         templateId: 'TechnicalRetro',    previewBg: '#FDFCFA', accentHex: '#E63946' },
  { id: 'glass-depth',          label: 'Glass Depth',          tagline: 'Glassmorphism · aurora background',      sampleId: 'finance',    Icon: Layers,      gradient: 'from-purple-950 via-indigo-950 to-violet-950',    textColor: 'text-violet-300',   iconBg: 'bg-violet-500/20',   templateId: 'TechnicalNature',   previewBg: '#0F0C29', accentHex: '#A78BFA' },
  { id: 'nature-organic',       label: 'Nature Organic',       tagline: 'Botanical · fluid · earthy',             sampleId: 'healthcare', Icon: Stethoscope, gradient: 'from-stone-100 via-green-50 to-lime-50',          textColor: 'text-green-700',    iconBg: 'bg-green-100',       templateId: 'TechnicalGraphicy', previewBg: '#F4F1EC', accentHex: '#5C7A3E' },
  { id: 'retro-vintage',        label: 'Retro Vintage',        tagline: 'Grain texture · slab serif · parchment', sampleId: 'creative',   Icon: BarChart2,   gradient: 'from-amber-50 via-stone-100 to-orange-50',        textColor: 'text-amber-800',    iconBg: 'bg-amber-100',       templateId: 'TechnicalCreative', previewBg: '#F5F0E8', accentHex: '#B5451B' },
]
