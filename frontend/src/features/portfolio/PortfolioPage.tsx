...
const CARDS: CategoryCard[] = [
  { id: 'modern-minimal',       label: 'Modern Minimal',       tagline: 'Clean · whitespace · type-first',        sampleId: 'tech',       Icon: Layers,      gradient: 'from-zinc-50 via-blue-50 to-slate-100',           textColor: 'text-blue-700',     iconBg: 'bg-blue-100',        templateId: 'TechnicalModern',    previewBg: '#FAFAFA', accentHex: '#2563EB' },
  { id: 'bold-impactful',       label: 'Bold Impactful',       tagline: 'Dark · huge type · commanding',          sampleId: 'tech',       Icon: Zap,         gradient: 'from-zinc-900 via-zinc-800 to-red-950',           textColor: 'text-red-400',      iconBg: 'bg-red-500/20',      templateId: 'TechnicalBold',       previewBg: '#0A0A0A', accentHex: '#FF3B00' },
  { id: 'dark-sleek',           label: 'Dark Sleek',           tagline: 'Premium dark · gold accents',            sampleId: 'tech',       Icon: Sparkles,    gradient: 'from-zinc-900 via-neutral-800 to-yellow-950',     textColor: 'text-yellow-400',   iconBg: 'bg-yellow-500/20',   templateId: 'TechnicalSleek',     previewBg: '#0D0D0D', accentHex: '#C9A96E' },
  { id: 'warm-human',           label: 'Warm Human',           tagline: 'Earthy · rounded · personal',            sampleId: 'tech',       Icon: Heart,       gradient: 'from-orange-50 via-amber-50 to-stone-100',        textColor: 'text-orange-700',   iconBg: 'bg-orange-100',      templateId: 'TechnicalWarm',     previewBg: '#FAF7F2', accentHex: '#C0622B' },
  { id: 'creative-studio',      label: 'Animated',             tagline: 'Parallax · scroll · motion',             sampleId: 'tech',       Icon: Palette,     gradient: 'from-stone-100 via-purple-50 to-stone-200',       textColor: 'text-purple-700',   iconBg: 'bg-purple-100',      templateId: 'TechnicalAnimated', previewBg: '#F0EDEB', accentHex: '#7B5EA7' },
  { id: 'tech-cyber',           label: 'Cyber Neon',          tagline: 'Terminal · neon · matrix grid',          sampleId: 'tech',       Icon: Code2,       gradient: 'from-slate-900 via-cyan-950 to-slate-900',        textColor: 'text-cyan-300',     iconBg: 'bg-cyan-500/20',     templateId: 'TechnicalVibrant',  previewBg: '#040A10', accentHex: '#00FF88' },
  { id: 'classic-professional', label: 'Classic Pro',         tagline: 'Serif · structured · print-ready',       sampleId: 'tech',       Icon: Briefcase,   gradient: 'from-slate-50 via-blue-50 to-slate-100',          textColor: 'text-blue-800',     iconBg: 'bg-blue-100',        templateId: 'TechnicalClassic',  previewBg: '#F8F8F6', accentHex: '#2A5298' },
  { id: 'vibrant-playful',      label: 'Glossy',               tagline: 'Glassmorphism · shiny · premium',        sampleId: 'tech',       Icon: TrendingUp,  gradient: 'from-yellow-50 via-orange-50 to-pink-50',         textColor: 'text-rose-600',     iconBg: 'bg-rose-100',        templateId: 'TechnicalGlossy',   previewBg: '#FFFBF0', accentHex: '#FF6B6B' },
  { id: 'editorial',            label: 'Retro Vintage',         tagline: 'Grain texture · serif · parchment',       sampleId: 'tech',       Icon: Type,        gradient: 'from-stone-50 via-red-50 to-stone-100',           textColor: 'text-red-700',      iconBg: 'bg-red-100',         templateId: 'TechnicalRetro',    previewBg: '#FDFCFA', accentHex: '#E63946' },
  { id: 'glass-depth',          label: 'Nature',               tagline: 'Organic · botanical · earthy',           sampleId: 'tech',       Icon: Layers,      gradient: 'from-purple-950 via-indigo-950 to-violet-950',    textColor: 'text-violet-300',   iconBg: 'bg-violet-500/20',   templateId: 'TechnicalNature',   previewBg: '#0F0C29', accentHex: '#A78BFA' },
  { id: 'nature-organic',       label: 'Graphic',             tagline: 'Data viz · charts · infographic',        sampleId: 'tech',       Icon: Stethoscope, gradient: 'from-stone-100 via-green-50 to-lime-50',          textColor: 'text-green-700',    iconBg: 'bg-green-100',       templateId: 'TechnicalGraphicy', previewBg: '#F4F1EC', accentHex: '#5C7A3E' },
  { id: 'retro-vintage',        label: 'Creative Techie',      tagline: 'Cyber · neon · glitch',                 sampleId: 'tech',       Icon: BarChart2,   gradient: 'from-amber-50 via-stone-100 to-orange-50',        textColor: 'text-amber-800',    iconBg: 'bg-amber-100',       templateId: 'TechnicalCreative', previewBg: '#F5F0E8', accentHex: '#B5451B' },
]
...
const PREVIEW_DATA: Record<string, { role: string; skills: string[]; companies: string[] }> = {
  'modern-minimal'       : { role: 'Software Engineer',        skills: ['Python',      'TypeScript',      'React',       'Go'],          companies: ['Stripe',     'Airbnb']      },
  'bold-impactful'       : { role: 'Tech Lead',               skills: ['System Design',   'AWS',     'Kubernetes',   'DevOps'],     companies: ['Google',       'Meta']        },
  'dark-sleek'           : { role: 'Backend Engineer',        skills: ['Go', 'Rust',     'PostgreSQL',     'Redis'],       companies: ['Cloudflare',  'Vercel']      },
  'warm-human'           : { role: 'Full Stack Dev',           skills: ['Node.js', 'React',      'MongoDB',      'GraphQL'],    companies: ['Shopify',     'Notion']      },
  'creative-studio'      : { role: 'DevOps Engineer',         skills: ['Docker','K8s',       'Terraform',     'CI/CD'],      companies: ['Datadog',     'GitHub']      },
  'tech-cyber'           : { role: 'Security Engineer',        skills: ['Python',       'C++',         'Linux',        'Pen Testing'], companies: ['CrowdStrike', 'Okta']       },
  'classic-professional' : { role: 'Data Engineer',            skills: ['SQL',          'Spark',       'Airflow',      'dbt'],        companies: ['Snowflake',   'Databricks']  },
  'vibrant-playful'      : { role: 'ML Engineer',             skills: ['PyTorch',      'TensorFlow',  'MLOps',        'Python'],     companies: ['OpenAI',      'DeepMind']    },
  'editorial'            : { role: 'Mobile Engineer',          skills: ['Swift',        'Kotlin',     'React Native', 'Flutter'],    companies: ['Uber',        'Spotify']     },
  'glass-depth'          : { role: 'Platform Engineer',        skills: ['Kubernetes',   'AWS',         'Python',        'Prometheus'], companies: ['Netflix',     'Spotify']     },
  'nature-organic'       : { role: 'Data Scientist',          skills: ['R',            'Python',      'Tableau',       'SQL'],        companies: ['Airbnb',      'Lyft']        },
  'retro-vintage'        : { role: 'QA Engineer',             skills: ['Selenium',     'Cypress',     'Python',        'API Testing'], companies: ['Atlassian',   ' Atlassian']  },
}
