...
GLOBAL_EMPLOYERS: dict[str, dict] = {
    ...
    # =======================================================================
    # VERIFIED 2026-05-06 — slot 3 probe
    # =======================================================================

    "aritzia": {
        "name":     "Aritzia",
        "base_url": "https://aritzia.wd3.myworkdayjobs.com",
        "tenant":   "aritzia",
        "site_id":  "External",
        "region":   "north_america",
        "country":  "Canada",
    ...
    "encorecapital": {
        ...
        "base_url": "https://encore.wd1.myworkdayjobs.com",
        "tenant":   "encore",
        "site_id":  "search",
        "region":   "north_america",
        "country":  "United States",
    ...
    "frostbank": {
        "name":     "Frost Bank",
        "base_url": "https://frostbank.wd5.myworkdayjobs.com",
        "tenant":   "frostbank",
        "site_id":  "External",
        "region":   "north_america",
        "country":  "United States",
    ...
    "goodlifefitness": {
        ...
        "base_url": "https://goodlifefitness.wd3.myworkdayjobs.com",
        "tenant":   "goodlifefitness",
        "site_id":  "careers",
        "region":   "north_america",
        "country":  "Canada",
        "industry": "retail",
    ...
    "hbfuller": {
        "name":     "H.B. Fuller",
        "base_url": "https://hbfuller.wd1.myworkdayjobs.com",
        "tenant":   "hbfuller",
        "site_id":  "careers",
        "region":   "north_america",
        "country":  "United States",
    ...
    "hancockwhitney": {
        ...
        "base_url": "https://hancockwhitney.wd5.myworkdayjobs.com",
        "tenant":   "hancockwhitney",
        "site_id":  "careers",
        "region":   "north_america",
        "country":  "United States",
        "industry": "finance",
    ...
    "mcafee": {
        "name":     "McAfee",
        "base_url": "https://mcafee.wd1.myworkdayjobs.com",
        "tenant":   "mcafee",
        "site_id":  "External",
        "region":   "north_america",
        "country":  "United States",
    ...
    "newschool": {
        "name":     "The New School",
        "base_url": "https://newschool.wd1.myworkdayjobs.com",
        "tenant":   "newschool",
        "site_id":  "External",
        "region":   "north_america",
        "country":  "United States",
    ...
    "univision": {
        "name":     "Univision",
        "base_url": "https://univision.wd1.myworkdayjobs.com",
        "tenant":   "univision",
        "site_id":  "External",
        "region":   "north_america",
        "country":  "United States",
    ...
    "archcapital": {
        "name":     "Arch Capital",
        "base_url": "https://archgroup.wd1.myworkdayjobs.com",
        "tenant":   "archgroup",
        "site_id":  "careers",
        "region":   "europe",
        "country":  "Bermuda",
