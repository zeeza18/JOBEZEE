...
from .routers import avatar_interview
...
app.include_router(avatar_interview.router, tags=["avatar-interview"])
app.include_router(resume_builder.router,   tags=["resume-builder"])
